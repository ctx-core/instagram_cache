...
import { medium_pathname_idx__ } from '../medium_pathname_idx__/index.js'
/** @type {typeof import(medium_pathname__).medium_pathname__} */
export const medium_pathname__ = be_('medium_pathname__', ctx=>{
	return computed_([
		...
		return (
			(medium_pathname_a === null || medium_pathname_a === void 0)
			? void 0
			: medium_pathname_a[medium_pathname_idx])
	})
})
