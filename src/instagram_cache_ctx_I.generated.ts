...
export function instagram_cache_b_h_b(ctx:instagram_cache_Ctx):instagram_cache_b_h_T {
	return be_<instagram_cache_Ctx, 'instagram_cache_b_h'>('instagram_cache_b_h', ()=>{
		return {
			get medium_pathname$() { return medium_pathname$_b(ctx) },
			get medium_pathname_a$() { return medium_pathname_a$_b(ctx) },
			get medium_pathname_idx$() { return medium_pathname_idx$_b(ctx) },
			get source_medium_pathname_a$() { return source_medium_pathname_a$_b(ctx) }
		}
	})(ctx)
}
